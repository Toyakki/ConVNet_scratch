...
class SegmentedMarsDataset(Dataset):
    def __init__(self, input_image_dir, segmented_mask_dir, crop_size=(256, 256), transform=None, mask_transform=None):
        """
    ...
    def __getitem__(self, idx):
        ...
        if self.mask_transform:
            segmented_mask = self.mask_transform(segmented_mask)
